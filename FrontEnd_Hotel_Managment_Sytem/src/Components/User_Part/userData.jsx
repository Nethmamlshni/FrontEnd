    ...
    if (!userFound) {
      return (
        <div className="flex flex-col items-center">
          <img
            src="https://png.pngtree.com/png-clipart/20210608/ourmid/pngtree-light-gray-silhouette-avatar-png-image_3418403.jpg" // Replace with the actual path to your default profile picture
            alt="Default Profile"
      ...
      <img
        ...
        src={
          userFound && userData?.img
            ? userData.img
            : "https://png.pngtree.com/png-clipart/20210608/ourmid/pngtree-light-gray-silhouette-avatar-png-image_3418403.jpg" // Show default profile photo if user not found
        }
        alt="User Profile"
        onClick={() => {
